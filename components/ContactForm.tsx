    ...
    <section id="contact" className="section-padding px-6 border-t border-[#27272a]">
      <div className="max-w-3xl mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-[-0.02em]">See one decision end to end</h2>
          <p className="text-[#a1a1aa] mb-10 text-lg leading-[1.6] max-w-2xl mx-auto">
            Score, gate, receipt. A walkthrough of one governed decision, start to finish, with your business context.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-[#a1a1aa]">
            ...
            <span className="flex items-center gap-2">
              <span className="text-blue-500">&#10003;</span> Sample scoring on representative data
            </span>
            <span className="flex items-center gap-2">
