...
const steps = [
  {
    ...
    desc: 'A pre-calibrated model evaluates fit, intent, and timing across 72+ signals. Intelligent from day one — no training period, no cold start.',
    code: [
  ...
  },
  {
    ...
    desc: 'Confidence thresholds determine what the system handles alone and what gets escalated. High confidence: execute. Low confidence: ask a human. Every action governed.',
    code: [
  ...
  },
  {
    ...
    desc: 'Every score, every gate evaluation, every routing decision logged to a searchable decision trail. If it happened, you can see why. Outcomes feed back to improve the next cycle.',
    code: [
