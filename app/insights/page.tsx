...
const articles = [
  ...
  },
  {
    ...
    description: 'In real time, signals fire across fit, intent, and timing, a conviction score calculates, a governance gate evaluates, and an autonomous decision executes. This is what it looks like.',
    tag: 'Product',
    readTime: '5 min read',
  },
]
