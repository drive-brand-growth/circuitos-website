...
export const metadata: Metadata = {
  ...
  description: 'In 4.2 seconds, signals fire across fit, intent, and timing, a conviction score calculates, a governance gate evaluates, and an autonomous decision executes. Here\'s what it looks like.',
  openGraph: {
    title: 'A Lead Enters CircuitOS at 2:47 PM. Here\'s What Happened Next.',
    description: 'In 4.2 seconds, signals fire across fit, intent, and timing, a conviction score calculates, and an autonomous decision executes.',
  ...
  twitter: {
    ...
    title: 'A Lead Enters CircuitOS at 2:47 PM',
    description: 'In 4.2 seconds, signals fire across fit, intent, and timing and an autonomous decision executes.',
  },
...
const jsonLd = {
  ...
  description: 'In 4.2 seconds, signals fire across fit, intent, and timing, a conviction score calculates, a governance gate evaluates, and an autonomous decision executes.',
      ...
      <article className="pt-28 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="[&_p]:text-[#a1a1aa] [&_p]:leading-relaxed [&_p]:mb-5 [&_p]:text-sm [&_p]:md:text-base [&_h2]:text-white [&_h2]:text-xl [&_h2]:md:text-2xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:md:mt-12 [&_h2]:mb-3 [&_h2]:md:mb-4">
            ...
            <p>
              At 2:47 PM, a VP of Operations filled out a form. At 2:47 PM and 4.2 seconds, the system had scored her across every fit, intent, and timing signal, evaluated its own confidence, determined it had the authority to act, routed her to the right engagement sequence, drafted a personalized outreach in the client&apos;s voice, and logged every step of its reasoning.
            </p>
