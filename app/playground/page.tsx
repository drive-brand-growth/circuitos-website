          ...
          {state.personaSelected && (
            ...
            >
              ...
              <p className="text-[#a1a1aa] mb-8 max-w-lg mx-auto">
                This playground runs on simulated signals. On your data, CircuitOS decisions run on your CRM, attribution, and live deal activity. Every call is calibrated, governed, and proven on a signed audit trail.
              </p>
              <Link
                href="/demo"
