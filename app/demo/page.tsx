...
const scoringPath: DemoStepData[] = [
  ...
  {
    module: 'scoring',
    headline: 'Bayesian model applies registered signals',
    narrative: {
      ...
      custom: 'Your custom signals flow right in. The Bayesian model combines them with the registered signal registry.',
    },
    metrics: [
      { label: 'Leads Incoming', base: 47, suffix: '' },
      { label: 'Signals Active', base: 24, suffix: '+' },
...
const outreachPath: DemoStepData[] = [
  ...
  {
    module: 'outreach', headline: 'Meeting booked and written to the audit trail',
    ...
    activeTab: 'Sequences', statusMessage: '12 meetings booked and logged to audit trail',
  },
  {
    module: 'outreach', headline: 'Action performance, fully auditable',
    narrative: { spreadsheets: 'From manual follow-ups to this. Every action, every outcome, every decision: one auditable trail.', basic_crm: 'Your CRM tracks contacts. CircuitOS tracks every governed action and its outcome in one view.', marketing_auto: 'The action analytics your platform is missing, tied to the decision that triggered each one.', custom: 'Full performance and audit data available via API. Dashboard included.' },
